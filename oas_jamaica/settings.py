"""
Django settings for oas_jamaica project.
"""
...
DATATYPE_LOCATIONS.append('oas_jamaica.datatypes')
FUNCTION_LOCATIONS.append('oas_jamaica.functions')
...
WSGI_APPLICATION = 'oas_jamaica.wsgi.application'
...
SESSION_COOKIE_NAME = 'oas_jamaica'
